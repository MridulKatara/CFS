      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        {allPrograms.length > 0 ? (
          ...
          <article
            ...
            className="relative rounded-xl p-5 overflow-hidden border border-[#e8dcf8] shadow-md cursor-pointer transition-all duration-300 hover:shadow-lg hover:translate-y-[-2px]"
            style={{ 
