...
export default function AboutIIT() {
    return (
      <section className="px-4 sm:px-6 lg:px-8 -mt-10 relative z-10">
        <div className="bg-white shadow-lg rounded-xl p-4 sm:p-5 lg:p-6 text-center max-w-4xl mx-auto">
          <h2 className="font-semibold text-lg sm:text-xl lg:text-2xl mb-2 text-[#202124]">
            About IIT Mandi
          </h2>
